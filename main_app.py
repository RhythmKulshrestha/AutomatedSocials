...
if platform == "Reddit":
    ...
    operation = st.sidebar.selectbox("Select Operation", ["Create Video", "Read Video", "Update Video", "Delete Video"])
    ...
    operation = st.sidebar.selectbox("Select Operation", ["Get Account Info", "Publish Post", "Get Media List"])
